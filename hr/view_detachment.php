...
$sql = "SELECT detachments.*, clients.client_name
        FROM detachments
        JOIN clients ON detachments.client_id = clients.id
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo htmlspecialchars($row['guards_required']); ?>
                        </td>
                    </tr>
                ...
                <h5 class="mt-4">
                    Assigned Guards
                    (<?php echo $assigned; ?> / <?php echo $required; ?>)
                </h5>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars($guard_row['employee_no']); ?>
                                    </td>

                                    <td>

                                        <img
                                            src="../assets/uploads/guards/<?php echo htmlspecialchars($guard_row['profile_picture']); ?>"
                                            width="60"
                                            height="60"
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars($guard_row['gender']); ?>
                                    </td>

                                    <td>
                                        <?php echo htmlspecialchars($guard_row['contact_no']); ?>
                                    </td>
                                </tr>
                                <?php } ?>
</tbody>
