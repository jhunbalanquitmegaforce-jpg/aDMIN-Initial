...
if (!empty($search)) {
    ...
    $sql = "SELECT detachments.*, clients.client_name
            ...
            WHERE detachments.detachment_name LIKE ?
               OR clients.client_name LIKE ?
               OR detachments.address LIKE ?
                    ...
                    <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <a
                                    href="view_detachment.php?id=<?php echo $row['id']; ?>"
                                ...
                                <a
                                    href="edit_detachment.php?id=<?php echo $row['id']; ?>"
                                ...
                                <a
                                    href="delete_detachment.php?id=<?php echo $row['id']; ?>"
