...
<div class="main-content">
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3>
                            <?php echo $summary['total_records']; ?>
                        </h3>
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3>
                            &#8369;<?php echo number_format($summary['total_gross'], 2); ?>
                        </h3>
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3>
                            &#8369;<?php echo number_format($summary['total_deductions'], 2); ?>
                        </h3>
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3>
                            &#8369;<?php echo number_format($summary['total_net'], 2); ?>
                        </h3>
    ...
    <div class="d-flex justify-content-center">
        ...
        <a
            href="payroll_print.php?guard_id=<?php echo urlencode($guard_id); ?>&from=<?php echo urlencode($from); ?>&to=<?php echo urlencode($to); ?>"
            target="_blank"
            class="btn btn-dark"
