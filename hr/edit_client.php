...
if (isset($_POST['update'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<div class='alert alert-danger m-3'>
                Error updating client: " . mysqli_error($con) . "
              </div>";
    }
}
?>
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-select">
                    ...
                    <option value="Active"
                        <?php if ($client['status'] == "Active") echo "selected"; ?>>
                        Active
                    </option>

                    <option value="Inactive"
                        <?php if ($client['status'] == "Inactive") echo "selected"; ?>>
                        Inactive
                    </option>
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    name="created_at"
                    class="form-control"
                    value="<?php echo htmlspecialchars($client['created_at']); ?>"
                    required
                >
            </div>
