...
if(isset($_POST['save'])) {
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO payroll 
        (guard_id, payroll_from, payroll_to, days_worked, rate_per_day, gross_pay, deductions, net_pay) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if(mysqli_stmt_execute($stmt)) {
        ...
        $g = mysqli_query(
            $con,
            "SELECT firstname, lastname FROM guards WHERE id = $guard_id"
        );
